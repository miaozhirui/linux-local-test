...
/******/ 			script.async = true;
/******/
/******/ 			script.src = __webpack_require__.p + "" + chunkId + "." + "b1e17a594d75ac5e9a62" + ".build.js";
...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(_reactRouter.Router, { history: _reactRouter.hashHistory, routes: _routes2.default }), document.getElementById('example'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		indexRoute: { component: __webpack_require__(218) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SelectDeparment = _react2.default.createClass({
		displayName: 'SelectDeparment',
		...
		render: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(DepartmentList, { data: data }),
	...
	var DepartmentList = _react2.default.createClass({
		...
		render: function render() {
			...
			data.forEach(function (item) {
				...
				list.push(_react2.default.createElement(LiItem, { item: item }));
			});
		...
		render: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					_reactRouter.Link,
					{ to: 'ask-question' },
					_react2.default.createElement('img', { src: this.props.item.DepartmentImg }),
					_react2.default.createElement(
						'p',
						null,
						_react2.default.createElement(
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'use-coupons', onClick: this.myCoupons.bind(this) },
							_react2.default.createElement('span', { className: 'icon' }),
							_react2.default.createElement(
								'span',
								{ className: 'desc' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  margin: 0px;\n  padding: 0px;\n}\nul,\nli {\n  list-style: none;\n}\n.select-department {\n  position: relative;\n}\n.select-department .select-title {\n  margin-top: 20px;\n  text-align: center;\n  color: #e75d3c;\n}\n.select-department h3 {\n  text-align: center;\n  margin: 8px 0;\n  color: #4a4a4a;\n  font-size: 14px;\n}\n.select-department ul {\n  width: 272px;\n  margin: 0 auto;\n  height: 100px;\n}\n.select-department ul li {\n  width: 120px;\n  height: 80px;\n  position: relative;\n  float: left;\n  margin-right: 5px;\n  margin-top: 16px;\n}\n.select-department ul li p {\n  position: absolute;\n  bottom: 2px;\n  text-align: center;\n  width: 100%;\n  font-size: 15px;\n  line-height: 30px;\n  background: -webkit-linear-gradient(top, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.5));\n}\n.select-department ul li a {\n  color: #fff;\n}\n.select-department ul li a img {\n  width: 100%;\n  height: 100%;\n}\n.select-department ul li:nth-of-type(2n) {\n  float: right;\n}\n.select-department .footer {\n  position: fixed;\n  bottom: 0;\n  width: 100%;\n  z-index: 100;\n  background: #fff;\n  opacity: 0.95;\n  padding-top: 5px;\n  padding-bottom: 5px;\n}\n.select-department .footer .box {\n  width: 100%;\n  text-align: center;\n  display: box;\n  display: -webkit-box;\n  display: -moz-box;\n  overflow: hidden;\n}\n.select-department .footer .box div {\n  height: 50px;\n}\n.select-department .footer .box .icon {\n  width: 28px;\n  height: 24px;\n  display: block;\n  margin: 0 auto;\n  margin-top: 5px;\n}\n.select-department .footer .box .use-coupons {\n  -webkit-box-flex: 1;\n  -moz-box-flex: 1;\n  box-flex: 1;\n  position: relative;\n}\n.select-department .footer .box .use-coupons .icon {\n  background: url(" + __webpack_require__(222) + ") no-repeat center;\n  background-size: contain;\n}\n.select-department .footer .box .search-record {\n  -webkit-box-flex: 1;\n  -moz-box-flex: 1;\n  box-flex: 1;\n  position: relative;\n}\n.select-department .footer .box .search-record .icon {\n  background: url(" + __webpack_require__(223) + ") no-repeat center;\n  background-size: contain;\n}\n.select-department .footer .box .search-record .line {\n  display: block;\n  right: 0px;\n  top: 15px;\n  height: 24px;\n  border-right: 1px solid #d8d8d8;\n  position: absolute;\n}\n.select-department .footer .box .doctor-team {\n  -webkit-box-flex: 1;\n  -moz-box-flex: 1;\n  box-flex: 1;\n  position: relative;\n}\n.select-department .footer .box .doctor-team .icon {\n  background: url(" + __webpack_require__(224) + ") no-repeat center;\n  background-size: contain;\n}\n.select-department .footer .box .doctor-team .line {\n  display: block;\n  right: 0px;\n  top: 15px;\n  height: 24px;\n  border-right: 1px solid #d8d8d8;\n  position: absolute;\n}\n.select-department .footer .box .desc {\n  display: block;\n  color: red;\n  font-size: 12px;\n  margin-top: 2px;\n}\n", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"

/***/ },
/* 223 */
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"

/***/ },
/* 224 */
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"
...
/***/ }
/******/ ]);
//# sourceMappingURL=b1e17a594d75ac5e9a62.build.js.map